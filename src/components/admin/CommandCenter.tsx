...
export default function CommandCenter() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-6 duration-1000">
      ...
      <motion.div 
        whileHover={{ y: -5 }}
        className="col-span-1 bg-gradient-to-br from-indigo-600 to-blue-700 p-6 rounded-[2.5rem] text-white shadow-xl relative overflow-hidden group shadow-indigo-500/20"
      >
        ...
        <div className="relative z-10">
          ...
          <h3 className="text-[10px] font-black uppercase tracking-widest text-indigo-100">Pasajeros Hoy</h3>
          <p className="text-5xl font-black italic tracking-tighter mt-2">{todayPax}</p>
          <div className="mt-4 flex items-center gap-2 text-[10px] font-bold text-indigo-100 uppercase">
      ...
      >
        <h3 className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-6 flex items-center gap-2">
          <Activity size={14} className="text-green-400" /> Radar de Staff
        </h3>
            ...
            <div key={i} className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[8px] font-bold text-green-400 flex items-center gap-1 uppercase">
                  <div className="w-1 h-1 rounded-full bg-green-400 animate-pulse"></div> En línea
                </span>
              </div>
            </div>
          ))}
      ...
      <div className="col-span-1 md:col-span-2 bg-white/40 backdrop-blur-xl border border-white/50 p-8 rounded-[2.5rem] shadow-xl">
        <div className="flex items-center justify-between mb-8">
           <h3 className="text-xs font-black text-[#0B132B] uppercase tracking-widest flex items-center gap-2">
             <ClipboardList size={16} className="text-indigo-600" /> Feed de Cotizaciones en Vivo
           </h3>
           <span className="text-[9px] font-black text-indigo-600 uppercase tracking-widest animate-pulse">Live Updates</span>
        </div>
        <div className="space-y-4">
          {recentQuotes.map((q, i) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div className="bg-white p-2 rounded-xl text-[10px] font-black italic text-indigo-600 shadow-sm group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                  {q.id}
                </div>
                <div className="flex flex-col">
